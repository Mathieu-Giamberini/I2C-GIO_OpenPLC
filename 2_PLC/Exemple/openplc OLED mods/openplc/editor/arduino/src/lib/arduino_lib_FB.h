...
typedef struct {
  ...
  __DECLARE_VAR(INT,TEMP)
  __DECLARE_VAR(SINT,HUMIDITY)
...
static void OLED_init__(OLED *data__, BOOL retain) {
...
// Code part
static void OLED_body__(OLED *data__) {
...
************************************************************************/
//definition of external functions
void *init_dbt11(uint8_t);
int request_dht11(void *);
int16_t read_dht11_temp(void *);
int8_t read_dht11_humidity(void *);

//definition of blocks
static void DHT11_init__(DHT11 *data__, BOOL retain) {
  __INIT_VAR(data__->EN,__BOOL_LITERAL(TRUE),retain)
  __INIT_VAR(data__->ENO,__BOOL_LITERAL(TRUE),retain)
  __INIT_VAR(data__->SETUP_BLOCK,__BOOL_LITERAL(FALSE),retain)
...
// Code part
static void DHT11_body__(DHT11 *data__) {
  ...
  // Initialise TEMP variables
  if (!__GET_VAR(data__->SETUP_BLOCK)) {
      (*data__).class_pointer = init_dht11((uint8_t)__GET_VAR(data__->PIN));
      __SET_VAR(data__->,SETUP_BLOCK,,__BOOL_LITERAL(TRUE));
  }
  __SET_VAR(data__->,STATE,,request_dht11((*data__).class_pointer));
  __SET_VAR(data__->,TEMP,,read_dht11_temp((*data__).class_pointer));
  __SET_VAR(data__->,HUMIDITY,,read_dht11_humidity((*data__).class_pointer));
